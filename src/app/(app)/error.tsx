...
export default function AppError({
  ...
  return (
    <div className="min-h-dvh grid place-items-center bg-tg-dark text-tg-text">
      <div className="max-w-2xl rounded-3xl border border-tg-border bg-tg-darker p-10 text-center shadow-sm">
        <p className="text-sm text-tg-text/70">Something went wrong while loading the app.</p>
        <h1 className="mt-4 text-3xl font-semibold text-white">Application error</h1>
